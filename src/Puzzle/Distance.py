...
def old_diff_match_edges(e1, e2, reverse=True, thres=5):
...
def diff_colors(e1_lab_colors, e2_lab_colors, reverse=False, JNC=2.3):
...
def diff_full_compute(e1, e2):
    ...
    edge_color_score = diff_colors(np.array(e1_lab_colors), np.array(e2_lab_colors), reverse=True, JNC=10)
